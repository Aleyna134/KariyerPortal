...
namespace KariyerPortal.Migrations
{
    ...
    [Migration("20250818215258_AddCompanyAndJobDetails")]
    partial class AddCompanyAndJobDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KariyerPortal.Models.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("KariyerPortal.Models.UserDetail", b =>
                {
                    b.HasOne("KariyerPortal.Models.AppUser", "AppUser")
                        .WithOne("UserDetail")
                        .HasForeignKey("KariyerPortal.Models.UserDetail", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("KariyerPortal.Models.AppRole", null)
                        .WithMany()
